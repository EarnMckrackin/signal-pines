...
func _build_route() -> void:
	...
	# Main Street opens once the crew at Zip's has set up the shoot; it carries
	# the line down to the Spillway.
	var main_street := SceneGate.new()
	main_street.target_scene = "res://scenes/routes/MainStreet.tscn"
	main_street.label_text = "Down Main Street"
	main_street.required_flag = "mission_zips_done"
	main_street.locked_text = "(find the crew at Zip's first)"
	main_street.position = Vector2(4120, 675)
